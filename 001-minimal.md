...
![plot of chunk unnamed-chunk-4](https://db.yihui.org/knitr-examples/figure/001-minimal-unnamed-chunk-4-1.png)

```r
hist(rnorm(1000))
```

![plot of chunk unnamed-chunk-4](https://db.yihui.org/knitr-examples/figure/001-minimal-unnamed-chunk-4-2.png)
