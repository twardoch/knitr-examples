...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# `stat\_bin2d()` using `bins = 30`. Pick better value `binwidth`.}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Removed 478 rows containing non-finite outside the scale range\\\#\# (`stat\_bin2d()`).}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Removed 5 rows containing missing values or values outside the scale range\\\#\# (`geom\_bin2d()`).}}\end{kframe}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Removed 478 rows containing non-finite outside the scale range\\\#\# (`stat\_bin2d()`).}}\end{kframe}
\includegraphics[width=\maxwidth]{figure/021-ggplot2-geoms-geom_bin_2d-2} 
\begin{kframe}\begin{alltt}
\hldef{d} \hlopt{+} \hlkwd{geom_bin_2d}\hldef{(}\hlkwc{bins} \hldef{=} \hlkwd{list}\hldef{(}\hlkwc{x} \hldef{=} \hlnum{30}\hldef{,} \hlkwc{y} \hldef{=} \hlnum{10}\hldef{))}
\end{alltt}


{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Removed 478 rows containing non-finite outside the scale range\\\#\# (`stat\_bin2d()`).}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Removed 2 rows containing missing values or values outside the scale range\\\#\# (`geom\_bin2d()`).}}\end{kframe}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Orientation is not uniquely specified when both the x and y aesthetics are\\\#\# continuous. Picking default orientation 'x'.}}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Orientation is not uniquely specified when both the x and y aesthetics are\\\#\# continuous. Picking default orientation 'x'.}}\end{kframe}
